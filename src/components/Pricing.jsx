...
const Pricing = () => {
    return (
        <>
            <section className="bg-[url('assets/img/Pricebg.svg')] bg-cover bg-no-repeat ">
                ...
                <section className="md:px-[100px] px-[10px] md:pb-[50px] pb-[50px]">
                    ...
                    <div className="grid justify-center pt-[40px] md:flex">
                        <div className="md:pr-[30px]">
                            <div className="md:bg-[#FFFFFF] bg-[#9375F4] rounded-lg flex md:w-[500px] w-[410px] h-[120px] md:h-[150px] mb-[30px]">
                            ...
                            <div className="md:bg-[#FFFFFF] bg-[#9375F4] rounded-lg flex md:w-[500px] md:h-[150px] w-[410px] h-[120px] mb-[30px]">
                                <p className="text-[#2D1D60;] text-[18px] font-medium m-auto text-center md:w-[58%]"> Which platforms are supported?</p>
                                <AiOutlineRight className="text-[40px] md:mt-[50px] mt-[40px] md:pr-[0px]" />
                            </div>
                            <div className="md:bg-[#FFFFFF] bg-[#9375F4] rounded-lg flex md:w-[500px] md:h-[150px] h-[120px] w-[410px] mb-[30px]">
